...
export default {
	...
	theming: {
		targets: [
			{
				className: 'astryx-typeahead',
				visualProps: ['status', 'size']
			},
			{
	...
	usage: {
		anatomy: [
			...
			},
			{
				name: 'Input surface',
				required: true,
				description: 'Painted control surface containing the editable input or the selected token.'
			},
			{
			...
			},
			{
				name: 'Selected token',
				required: false,
				description: 'Token that presents the selected item while the control is not in edit mode.'
			},
			{
				name: 'Spinner',
				required: false,
			...
			},
			{
				name: 'Clear button',
				required: false,
				description: 'Shared clear action that removes the selected item when hasClear is enabled.'
			},
			{
				name: 'Dropdown',
				required: false,
				description: 'Anchored listbox surface containing the current search results.'
			},
			{
				name: 'Empty state',
				required: false,
			...
			},
			{
				...
				required: false,
				description: 'Selected styling and trailing check presented on the current result row.'
			}
		],
		description:
		...
		bestPractices: [
			{
				guidance: true,
				description: 'Provide descriptive placeholder text that hints at what users can search for.'
			},
			{
				guidance: true,
				description:
			...
			{
				guidance: false,
				description: 'Use for short, static option lists; use Selector for better discoverability.'
			},
			{
				guidance: false,
