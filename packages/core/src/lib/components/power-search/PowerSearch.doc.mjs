	...
	props: [
		{
			...
			description: 'Configuration defining available fields, operators, and their value types.',
			required: true
		},
		{
			name: 'filters',
		...
		{
			name: 'handleRef',
			type: 'PowerSearchHandle | null',
			description: 'Imperative handle with focusTypeahead() and blurTypeahead() methods.'
		},
		{
			name: 'endContent',
			type: 'Snippet',
