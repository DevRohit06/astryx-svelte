...
/**
 * Ported from Astryx's `DateInput/tokens.stylex.ts`.
 *
 ...
 *
 * `defineConsts` emits no CSS custom property and no atomic class, so this
 * module has no entry in the class oracle — its effect shows up entirely
 * inside the modules that read it.
 */
