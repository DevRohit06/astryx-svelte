...
const styles = stylex.create({
	viewport: {
		...
		// edges cannot be honoured — the box resolves against the start edge at its
		// content width, and `align-items: flex-end` then aligns the toast to the
		// right of a box that is itself sitting on the left. Measured in Chromium at
		// 1200px wide: a 438px box at x=0, end-positioned toast landing at x=19.
		width: 'auto',
		margin: 0,
		border: 'none',
		background: 'none',
