...
export default {
	...
	usage: {
		...
		bestPractices: [
			{
				guidance: true,
				description: 'Provide a visible label so users understand what they are selecting.'
			},
			{
				guidance: true,
				description: 'Use sections and dividers to organize options when the list exceeds ~8 items.'
			},
			{
				guidance: true,
				description:
			...
			{
				guidance: false,
				description: 'Use Selector for navigation; links should be links, not dropdown options.'
			},
			{
				guidance: false,
				description: 'Use for yes/no or on/off choices; use Switch or CheckboxInput instead.'
			},
			{
				guidance: false,
				description:
		...
		anatomy: [
			...
			},
			{
				...
				required: false,
				description: 'Shared clear action that removes the selected value when hasClear is enabled.'
			},
			{
				name: 'Status icon',
				required: false,
	...
	props: [
		...
		{
			name: 'onChange',
			type: '((value: string) => void) | ((value: string | null) => void)',
