	...
	usage: {
		...
		anatomy: [
			...
			},
			{
				name: 'Line Numbers',
				required: false,
				description: 'Numbered gutter along the left edge. Enable with hasLineNumbers.'
			},
			{
				name: 'Code Body',
				required: true,
			...
			},
			{
				name: 'Copy Button',
				required: false,
				description: 'Copies the code string to the clipboard. Shown by default.'
			}
		]
	},
	playground: {
		defaults: {
			code: 'import {Button} from \'@astryx-svelte/core\';\n\nexport function App() {\n  return <Button label="Hello" variant="primary" />;\n}',
			language: 'tsx',
			hasCopyButton: true
		}
	},
