...
const styles = stylex.create({
	...
	// A single-edge fade names a physical direction, so it has to be mirrored
	// under RTL — the faded edge is the *scroll* start, which swaps sides.
	// `fadeBoth` is symmetric and needs no arm.
	fadeStart: {
		maskImage: {
