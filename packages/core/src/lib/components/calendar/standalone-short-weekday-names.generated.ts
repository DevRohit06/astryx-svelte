/**
 * @generated by upstream's `scripts/generate-cldr-weekdays.mjs` from Unicode CLDR
 * 48.2.0, and copied verbatim from Astryx's
 * `Calendar/standaloneShortWeekdayNames.generated.ts`. Do not edit by hand.
 *
 * Reference data, not code: this port has no CLDR pipeline of its own, and
 * regenerating the table independently would risk drifting from the strings
 * upstream's own oracle compares against.
 */
