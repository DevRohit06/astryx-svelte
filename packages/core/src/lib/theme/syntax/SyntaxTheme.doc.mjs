	...
	props: [
		{
			...
			description:
				'Syntax highlighting theme: a preset from @astryx-svelte/core/theme/syntax or a custom theme created with defineSyntaxTheme().',
			required: true
		},
		{
			name: 'children',
			type: 'Snippet',
			description: 'Content subtree. All CodeBlock components within will use this syntax theme.',
			required: true
		}
	]
};
