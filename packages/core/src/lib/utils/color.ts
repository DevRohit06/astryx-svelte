/**
 * Shared colour parsing/formatting primitives. Upstream keeps one home for the
 * parsers that were otherwise duplicated across the theme layer, charts and lab,
 * so consumers get one well-tested definition of "parse this colour".
 */
