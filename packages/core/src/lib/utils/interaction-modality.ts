/**
 * Ported from Astryx's `utils/interactionModality.ts`.
 *
 ...
 *
 * Module-public and **barrel-absent**, exactly as upstream leaves it — the same
 * standing `__resetDevWarnings` and `__resetLiveRegionsForTest` have here.
 * @internal
 */
