...
export const styles = stylex.create({
	container: {
		...
		'--_reveal-opacity': {
			default: 0,
			':hover:where(:not(:disabled,[aria-disabled="true"]))': { '@media (hover: hover)': 1 },
			':focus-within': 1,
			'@media (any-pointer: coarse)': 1
		},
		'--_reveal-position': {
			default: 'absolute',
			':hover:where(:not(:disabled,[aria-disabled="true"]))': { '@media (hover: hover)': 'static' },
			':focus-within': 'static',
		...
		'--_conceal-opacity': {
			default: 1,
			':hover:where(:not(:disabled,[aria-disabled="true"]))': { '@media (hover: hover)': 0 }
		},
	...
	stateInactive: {
		...
		'--_reveal-delay-reduced': {
			default: '0s, 0s',
			':hover:where(:not(:disabled,[aria-disabled="true"]))': { '@media (hover: hover)': '0s, 0s' },
			':focus-within': '0s, 0s',
			'@media (any-pointer: coarse)': '0s, 0s'
		},
		'--_conceal-opacity': {
		...
		'--_fade-delay': {
			default: '0s',
			':hover:where(:not(:disabled,[aria-disabled="true"]))': { '@media (hover: hover)': '0s' },
			':focus-within': '0s',
			'@media (any-pointer: coarse)': '0s'
		}
	},
