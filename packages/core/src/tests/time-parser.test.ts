/** PORTS: utils/timeParser.test.ts */
...
describe('formatISOTime', () => {
	...
	it('formats with seconds', () => {
		expect(formatISOTime({ hour: 14, minute: 30, second: 45 }, true)).toBe('14:30:45');
		expect(formatISOTime({ hour: 0, minute: 0, second: 0 }, true)).toBe('00:00:00');
...
describe('formatDisplayTime12h', () => {
	...
	it('formats with seconds', () => {
		expect(formatDisplayTime12h('14:30:45' as ISOTimeString, true)).toBe('2:30:45 PM');
	});
...
describe('formatDisplayTime24h', () => {
	...
	it('formats with seconds', () => {
		expect(formatDisplayTime24h('14:30:45' as ISOTimeString, true)).toBe('14:30:45');
	});
...
describe('compareTime', () => {
	it('compares times correctly', () => {
		expect(compareTime('14:30' as ISOTimeString, '14:30' as ISOTimeString)).toBe(0);
		expect(compareTime('14:30' as ISOTimeString, '14:31' as ISOTimeString)).toBeLessThan(0);
		expect(compareTime('14:31' as ISOTimeString, '14:30' as ISOTimeString)).toBeGreaterThan(0);
		expect(compareTime('00:00' as ISOTimeString, '23:59' as ISOTimeString)).toBeLessThan(0);
	});
...
describe('isTimeInRange', () => {
	it('returns true when in range', () => {
		expect(
			isTimeInRange('14:30' as ISOTimeString, '09:00' as ISOTimeString, '18:00' as ISOTimeString)
		).toBe(true);
		expect(
			isTimeInRange('09:00' as ISOTimeString, '09:00' as ISOTimeString, '18:00' as ISOTimeString)
		).toBe(true);
		expect(
			isTimeInRange('18:00' as ISOTimeString, '09:00' as ISOTimeString, '18:00' as ISOTimeString)
		).toBe(true);
	});

	it('returns false when out of range', () => {
		expect(
			isTimeInRange('08:59' as ISOTimeString, '09:00' as ISOTimeString, '18:00' as ISOTimeString)
		).toBe(false);
		expect(
			isTimeInRange('18:01' as ISOTimeString, '09:00' as ISOTimeString, '18:00' as ISOTimeString)
		).toBe(false);
	});

	it('handles undefined min/max', () => {
		expect(isTimeInRange('14:30' as ISOTimeString, undefined, undefined)).toBe(true);
		expect(isTimeInRange('14:30' as ISOTimeString, '09:00' as ISOTimeString, undefined)).toBe(true);
		expect(isTimeInRange('14:30' as ISOTimeString, undefined, '18:00' as ISOTimeString)).toBe(true);
	});
});
