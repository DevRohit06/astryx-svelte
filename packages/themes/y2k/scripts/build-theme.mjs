// Compiles the y2k theme definition into dist/theme.css, dist/index.js and
...
await buildThemePackage({
	...
	icons: { name: 'y2kIconRegistry', file: 'icons.svelte' }
});
