// Diffs our generated theme.css against `@astryxdesign/theme-chocolate`'s, in
// both directions. The comparison lives in `packages/themes/shared`, which every
...
await compareThemeCss({
	...
	upstreamPackage: '@astryxdesign/theme-chocolate',
