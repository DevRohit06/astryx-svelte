 ...
 * verbatim renderer (code) deliberately skips this. `--json` is unaffected — it
 * always carries the original data.
 * @param {string} s
 * @returns {string}
 */
function toAscii(s) {
 ...
 * (`astryx-svelte template X > +page.svelte`) and preserves doc/source content
 * exactly.
 * @param {string} source
