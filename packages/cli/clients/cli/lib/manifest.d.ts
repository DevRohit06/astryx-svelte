/**
 * Types for the CLI capability manifest emitted by `astryx-svelte manifest --json`
 * (and embedded under `data.manifest` of the bare `astryx-svelte --json` help
 * envelope).
 *
...
/** The `astryx-svelte manifest --json` envelope. */
