/**
 * @file CLI-level tests for `astryx-svelte layout check` exit-code parity.
 *
 ...
 * `clients/cli/commands/layout.exit-parity.test.mjs` at `v0.3.0`: 3 cases, 3
 * here, verbatim apart from the harness import path.
 */
...
describe('layout check — exit-code parity (--json vs human)', () => {
	it(
		'human mode exits 1 for an invalid (parseable) expression',
		async () => {
	...
	it(
		'--json exits 1 for the SAME invalid expression (modes agree)',
		async () => {
	...
	it(
		'a valid expression exits 0 in both modes',
		async () => {
