 ...
 *
 * `astryx-svelte init` is non-interactive by default: it installs the AGENTS.md/
 ...
 * `astryx-svelte init --features agents,theme,template`.
 ...
 * flags, enables the shared logger, calls init(), and maps the receipt's soft
 * agent-docs error to the exit code.
 */
