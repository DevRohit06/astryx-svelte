 ...
 *
 * Usage:
 *   astryx-svelte discover                           List all packages
 *   astryx-svelte discover @scope/name               List components in a package
 *   astryx-svelte discover @scope/name/Component     Show docs for a component
 *   astryx-svelte discover searchterm                Search across all packages
 */
						...
						if (result.data.length === 0) {
							if (result.meta && result.meta.configured === false) {
								emit(
									...
									text('Add integration package names to astryx-svelte.config.mjs:'),
