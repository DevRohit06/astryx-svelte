 ...
 *
 * Ported case-for-case from upstream `foundation/xle/print.test.mjs` at
 * `v0.3.0`: 5 cases, 5 here. Verbatim — the printers are registry-free, so
 * nothing in this file depends on which design system the branch ships.
 */
