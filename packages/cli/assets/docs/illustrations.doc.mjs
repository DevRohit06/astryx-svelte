/**
 * @file Illustration guidelines. Prose verbatim; the one example becomes Svelte
 * markup (`style="…"` is a string attribute here, not an object).
 */
		...
		},
		{
			...
			content: [
				...
				},
				{
					...
					code: `<script lang="ts">
	import { Center, Heading, Stack, Text } from '@astryx-svelte/core';
</script>
