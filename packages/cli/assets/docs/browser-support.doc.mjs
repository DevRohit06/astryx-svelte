/**
 * @file Browser support tiers. Verbatim from upstream: the tiers describe web
 * platform features (Popover API, CSS anchor positioning, `light-dark()`) that
 * this port depends on identically, and the one code block is plain feature
 * detection.
 */
