/**
 * @file Shadow / elevation tokens. Prose verbatim; the two code blocks become
 * Svelte markup and a `.stylex.ts` module reading `var(--shadow-*)`.
 */
		...
		},
		{
			...
			content: [
				...
				},
				{
					...
					code: `<script lang="ts">
	import { Card, ChatComposer, IconButton } from '@astryx-svelte/core';
</script>
...
<IconButton icon="add" label="New" variant="primary" elevation="med" />
		...
		},
		{
			...
			content: [
				...
				},
				{
					type: 'code',
					lang: 'ts',
					label: 'Applying elevation (surface.stylex.ts)',
		...
		},
		{
			...
			content: [
				...
				},
				{
					...
					style: 'dont',
					items: [
						'Hand-write a `box-shadow` in app code; set the `elevation` prop or read the `--shadow-*` tokens instead.',
