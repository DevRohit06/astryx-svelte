/**
 * @file Typography foundations. Prose verbatim; the three code blocks become
 * Svelte markup / plain TypeScript.
 */
			...
			content: [
				{
					...
					items: [
						...
						'Use <Heading level={1} type="display-1"> when display text is a page heading; it gives display-level sizing and the correct heading element in one prop pair.',
