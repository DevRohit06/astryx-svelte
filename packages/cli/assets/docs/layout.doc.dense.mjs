...
export const docsDense = {
	description: 'frame-first app layout: shell choice, region budgets, cards vs rows',
	sections: [
		{
			section: 'Frame First',
			title: 'Frame First',
		...
		},
		{
			...
			content: [
				{ type: 'prose', text: 'container choice tracks archetype, not preference.' },
				null,
				{
					type: 'prose',
					text: 'start from matching template (astryx-svelte template --list), study with --skeleton.'
				}
			]
		},
		{
