 ...
 *
 * Upstream has 3 cases; 3 here, verbatim. `term-log.mjs` is one of the few
 * codemod modules the port took unchanged — it routes through `humanLog`, which
 * this port already owns.
 */
