 ...
 * export through `parseCodemod` during `astryx-svelte upgrade`. Zod is sealed
 * here; authors write a plain object with a `type` discriminant (no factory).
 */
 ...
 * stamped-codemod union. Only evaluated when this file is in the program — see
 * the sibling note in `../config/parse.mjs` about `parse.d.mts` shadowing it out
 * of a wildcard include.
 *
