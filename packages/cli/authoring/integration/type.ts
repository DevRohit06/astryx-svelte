 ...
 * (`astryx-svelte.integration.{ts,mjs,js}`, sibling to the integration
 * package's package.json). Identity (name/version) comes from package.json, not
 * the manifest. Authors write a plain object against {@link AstryxIntegration};
