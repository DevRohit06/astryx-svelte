 ...
 * `astryx-svelte.integration.*`. Zod is sealed inside the parser; these exercise
 * the public contract (validated value out / readable error thrown) with the
 * same accept/reject set the old `AstryxIntegrationSchema` had.
 */
