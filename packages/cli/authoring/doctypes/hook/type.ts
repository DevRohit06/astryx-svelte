...
import type { ComponentBestPractice, HookParamDoc, HookReturnDoc, UsageDoc } from '../base/type';
 ...
 *
 *   /\*\* @type {import('@astryx-svelte/cli/authoring').HookDoc} \*\/
 *   export const docs = { ... };
 */
export interface HookDoc {
	 ...
	 *  Enables cross-referencing: \`astryx-svelte component Toast\` can mention
	 *  useToast, and \`astryx-svelte hook useToast\` can link back to Toast. */
	relatedComponents?: string[];
	/** Other hook names this hook is commonly used with. */
	relatedHooks?: string[];
	/** Import path, e.g. '@astryx-svelte/core/hooks' or '@astryx-svelte/core/Toast'. */
	importPath?: string;
