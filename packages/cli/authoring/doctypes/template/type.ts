...
export interface BaseTemplateDoc {
	 ...
	 *  the Svelte component import name (e.g. `"ChatMessageMetadata"`); for
	 ...
	 *  `astryx-svelte template <name>` — it's only hidden from the browsable
	 *  gallery. Use for duplicate/experimental variants. Scaffold templates are
