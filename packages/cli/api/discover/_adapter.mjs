 ...
 *   ./_package-scanner, and foundation/discovery/component-loader; the discover
 *   dispatcher + leaves consume it.
 */
...
function validateDocs(docs) {
	...
	if (typeof d.name !== 'string' || !d.name) return 'docs.name is missing or not a string';
	...
	if (d.components && !Array.isArray(d.components)) return 'docs.components must be an array';
