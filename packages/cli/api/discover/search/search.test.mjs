 ...
 *
 * Ported case for case: 7/7, verbatim apart from the fixture directory prefix,
 * which follows this repo's `.astryx-*` transient-fixture convention.
 */
...
beforeAll(() => {
	docsDir = fs.mkdtempSync(path.join(os.tmpdir(), '.astryx-discover-search-'));
	fs.writeFileSync(
