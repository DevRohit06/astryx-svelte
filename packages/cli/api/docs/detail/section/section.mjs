 ...
 *   `astryx-svelte --json docs <topic> <section>`. Throws ERR_UNKNOWN_SECTION
 *   when no section title matches.
...
export async function section(topic, sectionName, options = {}) {
	...
	if (typeof sectionName !== 'string' || !sectionName.trim()) {
		throw new AstryxError('A section name is required', undefined, ERROR_CODES.ERR_UNKNOWN_SECTION);
	}
