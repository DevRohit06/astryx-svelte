 ...
 *
 * Silent-by-default is the other half of the seam's stdout discipline: it is
 * what lets an `api/` function report progress without an embedder's process
 * acquiring output it never asked for.
 *
