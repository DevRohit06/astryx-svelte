 ...
 * the CLI (clients/cli/commands/layout.mjs) and scripted callers import from one
 * place. Each leaf is also importable directly (e.g. api/layout/expand/expand.mjs).
 * The shared analysis core lives in ./_adapter.mjs. `layout` has real
 * subcommands, so there is no flag-dispatch here — the CLI calls the leaf it
 * wants.
 *
