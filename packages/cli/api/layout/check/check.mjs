/**
 * @file `astryx-svelte layout check` leaf — validate a layout expression without
 ...
 * @position api — leaf over ../_adapter.mjs + foundation/xle/print
 */
...
/**
 * `astryx-svelte layout check "<expr>" [--form compact|outline]`
