 ...
 * `@clack/prompts` wizard, and `port/research/02` §7.3's interactive flow is 0.1.7-era.
 *
 ...
 * (clients/cli/commands/init.mjs), and the test suite stay unchanged.
 */
 ...
 * (e.g. clients/cli/commands/init.mjs uses
 * `import('../../api/init/init.mjs').InitOptions`). The canonical shapes stay
 * colocated in api/init/init.type.mjs.
