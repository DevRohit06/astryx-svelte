/**
 * @file init.remove leaf — the `--remove-agents` path behind `astryx-svelte init`.
 *
 ...
 * foundation/agent-docs; this leaf only wires the cwd.
 *
 * Note: removeAgentDocs() still logs its own per-file lines via humanLog
 * (shared foundation behavior) — so a programmatic remove is not perfectly
 * silent yet. Threading a logger through agent-docs is a separate cleanup.
 */
