...
import { swizzleCopy, rewriteImports, __resetSwizzleSurfaceCache } from './copy/copy.mjs';

export { rewriteImports, __resetSwizzleSurfaceCache };

/**
 * List swizzlable component directories, or copy one component's source for
 * customization.
 *
 * @param {string} [component] component name (`Button`) or directory name (`button`); omit to list
