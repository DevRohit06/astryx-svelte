 ...
 * `astryx-svelte --json component` outputs. `component(name, opts)` parses the
 * (name, options) pair, resolves the subject once via `_adapter`, and routes to
 * the correct leaf (list · detail · detail.props/source/showcase/blocks),
 * returning that leaf's envelope. The CLI command handler is a thin wrapper
 ...
 * @param {string} [options.package] - Scope to a specific external package (e.g. '@acme/widgets')
...
export { componentList } from './list/list.mjs';
export { componentDetail } from './detail/detail.mjs';
export { componentDetailProps } from './detail/props/props.mjs';
export { componentDetailSource } from './detail/source/source.mjs';
export { componentDetailShowcase } from './detail/showcase/showcase.mjs';
export { componentDetailBlocks } from './detail/blocks/blocks.mjs';
