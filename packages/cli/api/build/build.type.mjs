 ...
 * responses. The public `@astryx-svelte/cli/api` surface re-exports them.
 */

/**
 * astryx-svelte --json build (no query) — the "how to build a page" playbook signal.
 *
...
/**
 * astryx-svelte --json build "<idea>" — the composition kit for what you're building.
 *
 ...
 * @property {import('../search/search.type.mjs').SearchResultEntry[]} data.domain Idea-specific components/utils (≤6), excluding frame/foundation.
