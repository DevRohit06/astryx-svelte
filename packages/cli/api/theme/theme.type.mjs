 ...
 * directly (functions own their types); the public `@astryx-svelte/cli/api`
 * surface re-exports them, so consumers see the same names.
 *
 * Invocation                                        -> type discriminator
 * -------------------------------------------------------------------------
 * astryx-svelte --json theme build <file>           -> theme.build
...
/**
 * astryx-svelte --json theme build <file>
...
/**
 * astryx-svelte --json theme build <file> --check
...
/**
 * astryx-svelte --json theme add <slug>
