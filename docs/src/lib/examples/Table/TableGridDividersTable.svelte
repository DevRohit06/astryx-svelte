<!--
	Ported from upstream's `templates/blocks/components/Table/TableGridDividersTable.tsx`.
	Transcribed, not re-authored: the parity rule covers example content too.
-->
<script lang="ts">
	import { Table, proportional, pixel, type TableColumn } from '@astryx-svelte/core';
...
<Table data={metrics} {columns} idKey="id" dividers="grid" density="compact" />
