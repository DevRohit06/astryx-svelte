<!--
	Ported from upstream's `templates/blocks/components/SelectorOption/SelectorOptionShowcase.tsx`.
...
<script lang="ts">
	 ...
	 * reads are made total. Every role above carries a label and a description, so
	 * nothing about the rendered example moves.
	 */
