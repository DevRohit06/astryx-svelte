<!--
	Ported from upstream's `templates/blocks/components/TabList/TabListTabsWithIcons.tsx`.
...
-->
<script lang="ts">
	import { Tab, TabList } from '@astryx-svelte/core';
...
<TabList {value} onChange={(next) => (value = next)}>
